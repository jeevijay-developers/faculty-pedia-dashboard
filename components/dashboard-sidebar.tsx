        ...
        <div className="flex items-center gap-2">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-primary">
            ...
            <div className="flex flex-col">
              <span className="text-sm font-semibold text-sidebar-foreground">Faculty Pedia</span>
              <span className="text-xs text-sidebar-foreground/60">An educational platform</span>
            </div>
        </div>
      </div>
